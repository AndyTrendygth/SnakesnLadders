  ...
  return (
    ...
    <div className='bg-gray-800 rounded-lg mr-5 hover:shadow-gray-500 hover:shadow-lg pb-4 cursor-pointer'>
      <div className=' rounded-lg' >
        <Image src={post.featuredImage.url} alt="Article Image" className='object-contain rounded-lg' height={900} width={1600}  />
        <div className='flex flex-row pt-2' key={post.id}>
