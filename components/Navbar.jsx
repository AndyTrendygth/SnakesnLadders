...
const Navbar = () => {
  ...
  return (   
<nav className=" bg-gray-900 pt-3 pb-2 shadow-gray-900 shadow-lg">
    ...
    <div className="flex justify-between">
      ...
      <div className="md:flex hidden items-center space-x-1 text-white text-lg relative">
        <div className="relative">
          <button className="flex flex-row items-center px-3 mx-5 py-2 text-center rounded-md" onClick={handleClick2}>
  ...
  <div className="hidden md:flex items-center space-x-1 text-white text-lg pr-5">
    <Link href="/tools">
      <a className="hover:bg-purple-700 rounded-md px-3 py-2 mx-5">Tools</a>
    </Link>
    <Link href="/promocodes">
      <a className="py-2 px-3 hover:bg-purple-700 rounded transition duration-300">Promo Codes</a>
    </Link>   
...
<div className={`${active ? 'md:hidden' : "hidden"} `}>
  <div className="flex items-center space-x-1 text-white text-lg relative">
    <div className="relative">
      ...
      <div className={`${active2 ? '' : "hidden"} absolute w-full mt-2 rounded-md shadow-lg`}>
        <div className="px-2 py-2 bg-gray-900 rounded-md">
          {categories.map((category)=>(
            <Link key={category.slug} href={`/categories/${category.slug}`}>
              <a className='block px-4 py-2 mt-2 text-sm font-semibold bg-transparent rounded-md'>
                {category.name}
              </a>
            </Link>
          ))}
    ...
    <Link href="/about">
      <a className="py-2 px-3 hover:bg-purple-700 rounded transition duration-300">About</a>
    </Link>   
      <div className="search-box flex p-3 ">
        <input className="search-input py-2 px-3 rounded-lg bg-gray-500 hover:bg-gray-300 transition duration-300 outline-none" type="text" placeholder="Search something.."/>
      </div>
  </div>
  </div>
</div>
